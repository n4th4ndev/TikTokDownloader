...
const translations = {
  fr: {
    ...
    "footer.disclaimer.3": "• Les vidéos téléchargées proviennent directement des serveurs de TikTok",
  ...
  en: {
    ...
    "footer.disclaimer.3": "• Downloaded videos come directly from TikTok servers",
